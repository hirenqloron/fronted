      ...
      <div className={styles.corehr}>
        <div style={{ display: "flex" }}>
          <div className={styles.corehrheading}>
            ...
            <p>
            Employee onboarding tasks and exit tasks management
            </p>
          </div>
        ...
        <div className={styles.box1}>
          ...
          <div className={styles.box1data}>
            ...
            <p>
            Employee Onboarding flows and tasks Creation            </p>
          </div>
        ...
        <div className={styles.box2}>
          ...
          <div className={styles.box2data}>
            ...
            <p>
            Employee notice oeriods, exit task, approval chain and other things            </p>
          </div>
