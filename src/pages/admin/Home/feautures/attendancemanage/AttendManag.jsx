...
import styles from "./AttendManag.module.css";
      ...
      <div className={styles.corehr}>
        <div style={{ display: "flex" }}>
          <div className={styles.corehrheading}>
            ...
            <p>
            Employee attendance tracking and management</p>
          </div>
        ...
        <div className={styles.box1}>
          ...
          <div className={styles.box1data}>
            <p>Configure attendance capture scheme and tracking..</p>
            <p>
            Setup capture scheme and racking policy</p>
          </div>
        ...
        <div className={styles.box1}>
          ...
          <div className={styles.box1data}>
            <p>Configure Overtime Policies</p>
            <p>
            Setup overtime policies, paycodes and formula       </p>
          </div>
        ...
        <div className={styles.box1}>
          ...
          <div className={styles.box1data}>
            <p>Shift & weekly off configuration</p>
            <p>
            Setup shifts and weekly offs</p>
          </div>
        ...
        <div className={styles.box1}>
          ...
          <div className={styles.box1data}>
            <p>Settings & Time assignments</p>
            <p>
            Assign policies to employees and configure other settings</p>
          </div>
        ...
        <div className={styles.box1}>
          ...
          <div className={styles.box1data}>
            ...
            <p>
            Integrate your biometric device</p>
          </div>
